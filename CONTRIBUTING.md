...
If you find a bug or have a feature request, please [open an issue](https://github.com/nick-gauthier/tidyEOF/issues) on GitHub. When reporting a bug, please include:
...
- Use `rlang::abort()` for error conditions
